...
format:
  revealjs:
    ...
    slide-number: false
    preview-links: false
    output-file: "datastorytelling_uplanner"
    theme:
        - simple
...
::: columns
::: {.column width="40%"}
![](images/viz/all_charts_1.png){fig-align="center"}
:::
::: {.column width="40%"}
![](images/viz/all_charts_2.png){fig-align="center"}
:::
:::
...
:::
::: {.column width="70%"}
![](images/viz/basic_viz.jpeg){fig-align="center"}

[Sólo necesitas dominar 8 tipos de visualizaciones]{.fragment}
:::
:::
...
[Pide retroalimentación. Practica.]{.fragment}

[Ayuda, aprende y enseña a tus colegas]{.fragment}
